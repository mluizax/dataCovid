...
state = st.sidebar.selectbox('Qual estado deseja consultar?', estados)    # sidebar -> menu lateral
...
st.caption('Fonte: https://github.com/wcota/covid19br')    # caption -> info de rodapé 
